...
public class CustomUiActivity extends Activity {
    private String[] examples = new String[]
             ...
             { "自定义路段", "自定义路线纹理","自定义路口放大图", "自定义导航光柱","自定义自车","自定义全览按钮","自定义指南针","自定义路况按钮","自定义放大缩小按钮",
                     "自定义转向提示", "正北模式", "自定义道路选择(见代码)"};
